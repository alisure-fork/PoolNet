...
class ImageDataTrain(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        sal_image, _ = self.load_image(os.path.join(self.sal_root, im_name))
...
class ImageDataTest(data.Dataset):
    ...
    def __getitem__(self, item):
        image, im_size = ImageDataTrain.load_image(os.path.join(self.data_root, self.image_list[item]))
...
def my_train(run_name, lr=5e-5, wd=5e-4):
...
"""
2 2020-07-31 13:33:10 0.0702588307476222 0.8155492353441807 0.7172192681311088
"""
...
if __name__ == '__main__':
    ...
    my_test(run_name=_run_name, sal_mode="t", model_path='./results/{}/epoch_2.pth'.format(_run_name))
    pass
